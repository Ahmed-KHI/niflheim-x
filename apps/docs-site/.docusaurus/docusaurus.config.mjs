...
export default {
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "I:\\frame-works\\hela\\apps\\docs-site\\sidebars.js",
        ...
        "theme": {
          "customCss": "I:\\frame-works\\hela\\apps\\docs-site\\src\\css\\custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Niflheim-X Team. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
